"""
Script: Exploração dos Dados WRF do Ciclone Biguá
...
Inspeciona data/WRF_d02_bigua_LEC.nc — o arquivo corrigido (apenas
t, ght, omega, u, v; lat/lon reais). Gerado por
scripts/analysis_01_preprocessing/prepare_wrf_for_lec.py a partir do
arquivo bruto data/WRF_d02_bigua.nc.
"""
...
print("=" * 70)
print("EXPLORAÇÃO — CICLONE BIGUÁ (WRF, corrigido)")
print("=" * 70)
...
print(f"  Coordenada: levels ({len(levels)} níveis, hPa)")
print(f"  Valores: {levels}")
...
print("\nPróximo passo: python scripts/exploratory/inspect_structure_wrf.py (gera namelist do LEC)")
